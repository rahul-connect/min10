...
?>
         <?php
          $fetch = mysqli_query($con,"SELECT * FROM video WHERE id='$video_id' && status='0' LIMIT 1");
    ...
    <main>
        ...
        <h2 class="text-center"><?php echo $row['title']; ?></h2><hr>
             ...
             <a href="functions/function.php?approve=<?php echo $video_id; ?>"><button type="button" class="btn btn-success btn-lg">Approve</button></a>
             <a href="functions/function.php?disapprove=<?php echo $video_id; ?>"<button type="button" class="btn btn-danger btn-lg">Delete</button></a>
             </div></center>
